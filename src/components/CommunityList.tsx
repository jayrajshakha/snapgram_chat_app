            ...
            {communityStoreData.communities.length > 0 &&
              communityStoreData.communities.map((item) => {
                return (
                  <li
                    key={item.$id}
                    className="flex items-center justify-between p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-200 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white"
                  >

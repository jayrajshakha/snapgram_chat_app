...
const CommunityList = () => {
  ...
  return (
    <>
      {
         loading ? (<Loading />) : ( <div className="sm:w-[30%] lg:w-full h- max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
         ...
         <p className=" sm:hidden md:inline-block  p-2 text-sm font-normal text-gray-500 dark:text-gray-400">
           Connect with one of our available Community providers or create a new
           one.
         </p>
    ...
    // <div className="sm:w-[30%] lg:w-full h- max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
    //   <h2 className="mb-3 ml-4 text-base font-bold  text-blue-700 md:text-xl dark:text-white">
    //     Communities
    //   </h2>
    //   <p className=" sm:hidden md:inline-block  p-2 text-sm font-normal text-gray-500 dark:text-gray-400">
